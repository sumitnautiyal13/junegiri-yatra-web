...
export const metadata: Metadata = {
  title: 'Thailand Tour Packages from Your City 2026',
  description: 'Book 7N/8D Thailand from Indian cities — Bangkok, Phuket & Pattaya. From $650/person, all-inclusive.',
