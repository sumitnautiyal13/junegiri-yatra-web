...
export const metadata: Metadata = {
  title: 'Himalayan Treks 2025–26 | Uttarakhand & Himachal Pradesh | Junegiri Yatra',
...
const HP_EASY: Array<{
  ...
  },
  {
    ...
    duration: '3–4 days',
    highlight: 'Passes through forests, rivers, and mountain villages. In May you can still find snow near the lake — magical experience.',
    difficulty: 'Easy–Moderate',
    diffColor: '#3DC9A0',
  ...
  },
  {
    ...
    duration: '3 days',
    highlight: 'Easy glacier trek near Manali with great wildflower views. Source of the Beas river.',
    difficulty: 'Easy–Moderate',
    diffColor: '#3DC9A0',
...
const HP_MODERATE: Array<{
  ...
  },
  {
    ...
    duration: '8 days',
    highlight: 'Best in May–June. Trails filled with snow bridges and melting glaciers. Meadows lush green with blooming flowers.',
    difficulty: 'Moderate–Difficult',
    diffColor: '#E8AA50',
  ...
  },
  {
    ...
    duration: '6–7 days',
    highlight: "Among the highest non-technical summit climbs in India. Fast-filling — book well in advance. Set in Spiti Valley.",
    difficulty: 'Difficult',
    diffColor: '#E05C00',
  ...
  },
  {
    ...
    duration: '10–11 days',
    highlight: 'Challenging, remote, connects Kullu to Spiti. One of the most adventurous high-altitude crossings in Himachal Pradesh.',
    difficulty: 'Difficult',
    diffColor: '#E05C00',
