...
const UK_TREKS = [
  ...
  },
  {
    ...
    tag: 'Winter Trek',
    tagColor: '#3B82F6',
    altitude: '3,708m / 12,165 ft',
    season: 'Nov–Feb',
    highlights: ['Frozen Brahmatal lake at 3,462m', 'Views of Trishul & Nanda Ghunti', 'Snow-covered bugyals'],
    image: '/images/solo_trek_uttarakhand.webp',
    desc: 'Walk across a frozen Himalayan lake. Brahmatal offers a classic winter wonderland experience with stunning views of Trishul (7,120m) and Nanda Ghunti in the Chamoli Himalaya.',
    hasPage: true,
  },
  {
    slug: 'dayara-bugyal-trek-4n-5d',
    name: 'Dayara Bugyal',
    duration: '4N / 5D',
    price: '₹5,000',
    difficulty: 'Easy–Moderate',
    ...
    season: 'Sep–Mar',
    highlights: ["Uttarakhand's largest alpine meadow", '360° views from Bakaria Top', 'Ideal beginner trek'],
    image: '/images/valley_trek.webp',
    desc: "28 sq km of rolling alpine meadow at 3,408m — one of India's most expansive bugyals. Green in autumn, snow-white in winter, with sweeping views of Bandarpunch and the Gangotri peaks.",
    hasPage: true,
  },
  {
