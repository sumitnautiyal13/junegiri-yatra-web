...
export async function generateMetadata({
  ...
  const title = fitTitle(`Varanasi Tour from ${city.name}`, ['2026', '— from ₹7,500']);
  const description = fitDescription(`Book a Varanasi spiritual tour from ${city.name} — all-inclusive from ₹7,500.`, ['Ganga aarti, Kashi Vishwanath & a sunrise boat ride.', `${city.total_time}.`, 'WhatsApp for a quote.']);
