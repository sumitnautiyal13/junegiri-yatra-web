  ...
  '@graph': [
    ...
    },
    {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 2, name: 'Do Dham Packages', item: 'https://junegiriyatra.com/packages/do-dham-yatra-5n-6d/' },
        { '@type': 'ListItem', position: 3, name: 'From Your City', item: 'https://junegiriyatra.com/do-dham-from/' },
      ],
    },
  ],
};
      ...
      <section className="city-hero" style={{ minHeight: '55vh' }}>
        ...
        <div className="container city-hero-inner">
          <nav className="city-breadcrumb" aria-label="Breadcrumb">
            <Link href="/">Home</Link>
            <span>›</span>
            <Link href="/packages/do-dham-yatra-5n-6d/">Do Dham</Link>
            <span>›</span>
          ...
          <p className="city-hero-sub">
            Pick your departure city · Kedarnath Jyotirlinga + Badrinath Vishnu shrine · 5N/6D.
            All-inclusive packages from{' '}
            <strong>₹13,500 / person</strong>
          </p>
          <a
            href="https://wa.me/919873897652?text=Namaste!%20I%20want%20to%20book%20Do%20Dham%20Yatra%20package"
      ...
      <section className="city-section">
        <div className="container">
          ...
          <p className="section-sub-left">
            ...
            city-specific Do Dham Yatra package quote.
          </p>
      ...
      <section className="city-section city-section-dark">
        <div className="container">
          ...
          <p className="section-sub-left light">
            Regardless of your departure city, the Do Dham Yatra package covers all of this.
          </p>
          <div className="cdf-includes-grid">
            {[
              { icon: '🏨', title: '5 Nights Hotels', desc: 'Accommodation at Haridwar, Guptkashi, Kedarnath, Joshimath & Badrinath — standard or deluxe options' },
              { icon: '🚐', title: 'Private AC Vehicle', desc: 'Dedicated private vehicle for the entire Do Dham circuit from Haridwar and back' },
              { icon: '🧭', title: 'Both Shrine Guides', desc: 'Certified Kedarnath trek guide + Badrinath pujari-guide — expert coverage at both dhams' },
              { icon: '📋', title: 'All Permits & Biometric', desc: 'Biometric registration, forest permits, and temple darshan registration for both shrines — fully managed' },
      ...
      <section className="city-section">
        <div className="container">
          ...
          <div className="cdf-steps">
            {[
              { step: '01', title: 'Pick Your City', desc: 'Click your departure city above to see exact flight options, fares, and a city-specific Do Dham Yatra itinerary.' },
              ...
              { step: '04', title: 'Book & Go', desc: 'Pay a small advance to confirm. We handle airport transfers, hotels, permits, biometric, and both shrine guides. You focus on the pilgrimage.' },
            ].map((s) => (
        ...
        <div className="container city-cta-inner">
          <div>
            ...
            <p className="city-cta-sub">
              Talk to our Haridwar team — we&apos;ve been guiding pilgrims to Kedarnath &amp; Badrinath since 2017.
            </p>
          </div>
          <div className="city-cta-btns">
            <a
              href="https://wa.me/919873897652?text=Namaste!%20I%20want%20to%20book%20Do%20Dham%20Yatra"
