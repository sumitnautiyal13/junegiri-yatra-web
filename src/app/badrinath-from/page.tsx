...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'All-inclusive Badrinath Yatra packages from 20 Indian cities. Lord Vishnu shrine, Mana Village & Vasudhara Falls.',
  ...
  '@graph': [
    {
      ...
      description: 'Badrinath Yatra packages with city-specific travel routes from 20 Indian departure cities.',
  ...
  return (
    <>
      ...
      <section
        className="city-hero"
        style={{
          backgroundImage: "url('/images/badrinath_temple.jpg')",
          minHeight: '55vh',
        }}
      >
