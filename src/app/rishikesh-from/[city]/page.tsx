...
export async function generateMetadata({
  ...
  const title = fitTitle(`Rishikesh Trip from ${city.name}`, ['2026', '— from ₹5,500']);
  const description = fitDescription(`Book a Rishikesh adventure trip from ${city.name} — all-inclusive from ₹5,500.`, ['Rafting, bungee jumping & riverside camping.', `${city.total_time}.`, 'WhatsApp for a quote.']);
