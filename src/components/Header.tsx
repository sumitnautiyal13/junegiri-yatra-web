      ...
      columns: [
        {
          ...
          items: [
            { icon: '🏝️', label: 'Bali, Nusa Penida & Gili 7D/6N', sub: 'Beaches · Scuba · Party · ATV · from $530/person', href: '/packages/bali-7d6n-party-escape/', badge: 'Popular' },
            { icon: '🌴', label: 'Thailand Tour 7N/8D', sub: 'Bangkok · Phuket · Pattaya · from $650/person', href: '/packages/thailand-tour-7n-8d/', badge: 'New' },
            { icon: '🏙️', label: 'Dubai Tour 5N/6D', sub: 'Burj Khalifa · Desert Safari · Marina · from $750/person', href: '/packages/dubai-tour-5n-6d/', badge: 'New' },
            { icon: '🌆', label: 'Singapore Tour 5N/6D', sub: 'Sentosa · Gardens · Universal Studios · from $680/person', href: '/packages/singapore-tour-5n-6d/', badge: 'New' },
          ],
        },
        {
